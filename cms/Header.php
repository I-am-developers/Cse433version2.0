...
<div id="templatemo_banner">
    ...
    <div id="login">
        ...
        <form action="login.php" method="post">
            <label><span style="color: white;font-size: 16px;" class="style1">Username</span></label>
            <input type="text" value="" name="username" size="10" class="input_field" title="username" />
            <label><span style="color: white;font-size: 16px;" class="style1">Password</span></label>
            <input type="password" value="" name="password" class="input_field" title="password" />
            <label><span style="color: white;font-size: 16px;" class="style1">Select User</span></label>
